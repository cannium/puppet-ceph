...
#   Optional. ceph.conf/[global]/filestore_xattr_use_omap parameter
#
# [*ms_nocrc*]
#   Optional. ceph.conf/[global]/ms_nocrc parameter
class ceph (
  $fsid,
  $ensure                     = present,
  ...
  if $ensure !~ /(absent|purged)/ {
    ...
    ceph_config {
      ...
      'global/cluster_addr':                value => $cluster_addr;
      ...
      'global/ms_nocrc':                    value => $ms_nocrc;
      'global/mon_osd_down_out_interval':   value => $mon_osd_down_out_interval;
      'global/mon_osd_min_down_reporters':   value => $mon_osd_min_down_reporters;
    }
